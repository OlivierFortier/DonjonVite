...
export class SceneChargement extends Phaser.Scene {
    ...
    preload() {
        ...
        this.barre = this.add.rectangle(0, this.game.config.height / 2, this.game.config.width, this.game.config.height * 0.15, 0xff0040);
        ...
        this.texteProgression = this.add.text(this.game.config.width / 2, this.game.config.height / 2, "0%", {
        ...
        this.load.plugin("Phaser3Swipe", "../../js/plugin/Phaser3Swipe.min.js", true);
    }
    /**
